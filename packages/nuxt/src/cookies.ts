/**
 * Cookie names and helpers for Nuxt-owned Loomup sessions.
 *
 * Same defaults as `@loomup/next` / `@loomup/astro` (distinct from server
 * cookie_mode names `loomup_access` / `loomup_refresh`).
 */
...
export const DEFAULT_ACCESS_MAX_AGE = 900; // 15m
...
/**
 * Serialize a single cookie to a Set-Cookie header value.
 */
